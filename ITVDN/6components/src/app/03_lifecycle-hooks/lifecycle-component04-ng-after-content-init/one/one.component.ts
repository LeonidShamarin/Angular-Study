...
export class OneComponent
  implements
    ...
    OnDestroy
{
  @ContentChild(TwoComponent)
  Content_twoComponent!: TwoComponent;
  @ContentChild('element')
  pElementHTML!: ElementRef;
  constructor() {
    console.log(
      `ONE - constructor \n twoContentChild`,
      this.Content_twoComponent
    );
  }
  ngOnChanges() {
    console.log(
